...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.vi_estimator = VehicleInsuranceEstimator(bucket_name=model_pusher_config.bucket_name,
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        try:
            ...
            self.vi_estimator.save_model(from_file=self.model_evaluation_artifact.trained_model_path)
